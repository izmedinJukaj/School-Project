...
public class CustomersUI {
	...
	private VBox addCustomerPane=new VBox();
	...
	public CustomersUI() {
		...
		table.setPrefWidth(290);
		
		pane.getChildren().addAll(table, addCustomerPane);
		addCustomerPane.getChildren().addAll(addCustomerLabel,addPane);
